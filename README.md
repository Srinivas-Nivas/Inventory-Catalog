...
Tech Stack: React | Spring Boot | Spring Data JPA | H2 Database | Maven | Docker | Nginx

Quick Start:

Docker: docker-compose up --build → Access at localhost:3000
Local: Backend: mvn spring-boot:run + Frontend: npm start
